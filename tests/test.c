...
const uint64_t refval_2atonce[80] = { 0 };
const uint64_t refval_2atonce128[80] = { 0 };
const uint64_t refval_2stream[80] = { 0 };
const uint64_t refval_2stream128[80] = { 0 };

const uint64_t refval_64le[80] = {
...
bool verify(const char *title, uint64_t (*hash)(const void *, size_t, uint64_t),
  ...
  bool failed = false;
  failed |= probe(hash, "empty-zero", 0, NULL, 0, zero, ignore_errors);
